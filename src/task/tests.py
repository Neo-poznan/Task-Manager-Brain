...
class CompanyTest(TestCase):
    ...
    def _save_completed_task_to_history(self, task_id: int, execution_time: timedelta):
        response = self.client.post(f'/complete-task/{task_id}/', {'execution_time': execution_time})
        return response

    def _save_failed_task_to_history(self, task_id: int, execution_time: timedelta):
        response = self.client.post(f'/fail-task/{task_id}/', {'execution_time': execution_time})
        return response    
